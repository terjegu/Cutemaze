...
QMAKE    = /usr/bin/qmake
cutemaze.xcodeproj/project.pbxproj: cutemaze.pro  /usr/local/Qt4.5/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.5/mkspecs/common/unix.conf \
	...
	$(QMAKE) -macx -o cutemaze.xcodeproj/project.pbxproj cutemaze.pro
