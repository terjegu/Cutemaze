...
:	QDialog(parent)
{
	...
	controls.append(new ControlButton("Talk", Qt::Key_Shift, this)); // ADDED BY LARS PETTER MOSTAD
	...
	controls_layout->addWidget(new QLabel(tr("Push To Talk"), controls_tab), 6, 1, Qt::AlignRight | Qt::AlignVCenter); // ADDED BY LARS PETTER MOSTAD
	controls_layout->addWidget(controls[5], 6, 2); // ADDED BY LARS PETTER MOSTAD
